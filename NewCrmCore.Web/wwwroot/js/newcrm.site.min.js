 ...
 */
eval(function(n,t,i,r,u,f){function e(n){return n<62?String.fromCharCode(n+=n<26?65:n<52?71:-4):n<63?"_":n<64?"$":e(n>>6)+e(n&63)}while(i>0)u[e(r--)]=t[--i];return n.replace(/[\w\$]+/g,function(n){return u[n]==f[n]?n:u[n]})}('(6(E,C,D,A){c B,X,W,J="@_.DATA",K="@_.OPEN",H="@_.OPENER",I=C.k=C.k||"@_.WINNAME"+(Bd Bo).Be(),F=C.VBArray&&!C.XMLHttpRequest;E(6(){!C.Bu&&7.BY==="B0"&&Br("9 Error: 7.BY === \\"B0\\"")});c G=D.d=6(){c W=C,X=6(A){f{c W=C[A].7;W.BE}u(X){v!V}v C[A].9&&W.BE("frameset").length===U};v X("d")?W=C.d:X("BB")&&(W=C.BB),W}();D.BB=G,B=G.9,W=6(){v B.BW.w},D.m=6(C,B){c W=D.d,X=W[J]||{};W[J]=X;b(B!==A)X[C]=B;else v X[C];v X},D.BQ=6(W){c X=D.d[J];X&&X[W]&&1 X[W]},D.through=X=6(){c X=B.BR(i,BJ);v G!==C&&(D.B4[X.0.Z]=X),X},G!==C&&E(C).BN("unload",6(){c A=D.B4,W;BO(c X BS A)A[X]&&(W=A[X].0,W&&(W.duration=U),A[X].s(),1 A[X])}),D.p=6(B,O,BZ){O=O||{};c N,L,M,Bc,T,S,R,Q,BF,P=D.d,Ba="8:BD;n:-Bb;d:-Bb;Bp:o U;Bf:transparent",BI="r:g%;x:g%;Bp:o U";b(BZ===!V){c BH=(Bd Bo).Be(),BG=B.replace(/([?&])W=[^&]*/,"$1_="+BH);B=BG+(BG===B?(/\\?/.test(B)?"&":"?")+"W="+BH:"")}c G=6(){c B,C,W=L.2.B2(".aui_loading"),A=N.0;M.addClass("Bi"),W&&W.hide();f{Q=T.$,R=E(Q.7),BF=Q.7.Bg}u(X){T.q.5=BI,A.z?N.z(A.z):N.8(A.n,A.d),O.j&&O.j.l(N,Q,P),O.j=By;v}B=A.r==="Bt"?R.r()+(F?U:parseInt(E(BF).Bv("marginLeft"))):A.r,C=A.x==="Bt"?R.x():A.x,setTimeout(6(){T.q.5=BI},U),N.Bk(B,C),A.z?N.z(A.z):N.8(A.n,A.d),O.j&&O.j.l(N,Q,P),O.j=By},I={w:W(),j:6(){N=i,L=N.h,Bc=L.BM,M=L.2,T=N.BK=P.7.Bn("BK"),T.Bx=B,T.k="Open"+N.0.Z,T.q.5=Ba,T.BX("frameborder",U,U),T.BX("allowTransparency",!U),S=E(T),N.2().B3(T),Q=T.$;f{Q.k=T.k,D.m(T.k+K,N),D.m(T.k+H,C)}u(X){}S.BN("BC",G)},s:6(){S.Bv("4","o").unbind("BC",G);b(O.s&&O.s.l(i,T.$,P)===!V)v!V;M.removeClass("Bi"),S[U].Bx="about:blank",S.remove();f{D.BQ(T.k+K),D.BQ(T.k+H)}u(X){}}};Bq O.Y=="6"&&(I.Y=6(){v O.Y.l(N,T.$,P)}),Bq O.y=="6"&&(I.y=6(){v O.y.l(N,T.$,P)}),1 O.2;BO(c J BS O)I[J]===A&&(I[J]=O[J]);v X(I)},D.p.Bw=D.m(I+K),D.BT=D.m(I+H)||C,D.p.origin=D.BT,D.s=6(){c X=D.m(I+K);v X&&X.s(),!V},G!=C&&E(7).BN("mousedown",6(){c X=D.p.Bw;X&&X.w()}),D.BC=6(C,D,B){B=B||!V;c G=D||{},H={w:W(),j:6(A){c W=i,X=W.0;E.ajax({url:C,success:6(X){W.2(X),G.j&&G.j.l(W,A)},cache:B})}};1 D.2;BO(c F BS G)H[F]===A&&(H[F]=G[F]);v X(H)},D.Br=6(B,A){v X({Z:"Alert",w:W(),BL:"warning",t:!U,BA:!U,2:B,Y:!U,s:A})},D.confirm=6(C,A,B){v X({Z:"Confirm",w:W(),BL:"Bm",t:!U,BA:!U,3:U.V,2:C,Y:6(X){v A.l(i,X)},y:6(X){v B&&B.l(i,X)}})},D.prompt=6(D,B,C){C=C||"";c A;v X({Z:"Prompt",w:W(),BL:"Bm",t:!U,BA:!U,3:U.V,2:["<e q=\\"margin-bottom:5px;font-Bk:12px\\">",D,"<\/e>","<e>","<Bl B1=\\"",C,"\\" q=\\"r:18em;Bh:6px 4px\\" />","<\/e>"].join(""),j:6(){A=i.h.2.B2("Bl")[U],A.select(),A.BP()},Y:6(X){v B&&B.l(i,A.B1,X)},y:!U})},D.tips=6(B,A){v X({Z:"Tips",w:W(),title:!V,y:!V,t:!U,BA:!V}).2("<e q=\\"Bh: U 1em;\\">"+B+"<\/e>").time(A||V.B6)},E(6(){c A=D.dragEvent;b(!A)v;c B=E(C),X=E(7),W=F?"BD":"t",H=A.prototype,I=7.Bn("e"),G=I.q;G.5="4:o;8:"+W+";n:U;d:U;r:g%;x:g%;"+"cursor:move;filter:alpha(3=U);3:U;Bf:#FFF",7.Bg.B3(I),H.Bj=H.Bs,H.BV=H.Bz,H.Bs=6(){c E=D.BP.h,C=E.BM[U],A=E.2[U].BE("BK")[U];H.Bj.BR(i,BJ),G.4="block",G.w=D.BW.w+B5,W==="BD"&&(G.r=B.r()+"a",G.x=B.x()+"a",G.n=X.scrollLeft()+"a",G.d=X.scrollTop()+"a"),A&&C.offsetWidth*C.offsetHeight>307200&&(C.q.BU="hidden")},H.Bz=6(){c X=D.BP;H.BV.BR(i,BJ),G.4="o",X&&(X.h.BM[U].q.BU="visible")}})})(i.art||i.Bu,i,i.9)',"P|R|T|U|V|W|0|1|_|$|ok|id|px|if|var|top|div|try|100|DOM|this|init|name|call|data|left|none|open|style|width|close|fixed|catch|return|zIndex|height|cancel|follow|config|delete|content|opacity|display|cssText|function|document|position|artDialog|ARTDIALOG|contentWindow|lock|parent|load|absolute|getElementsByTagName|S|Y|Z|a|arguments|iframe|icon|main|bind|for|focus|removeData|apply|in|opener|visibility|_end|defaults|setAttribute|compatMode|O|Q|9999em|X|new|getTime|background|body|padding|aui_state_full|_start|size|input|question|createElement|Date|border|typeof|alert|start|auto|jQuery|css|api|src|null|end|BackCompat|value|find|appendChild|list|3|5".split("|"),109,122,{},{})),function(){var n={title:"消息通知",width:250,msgData:[],noticeData:[],msgUnReadData:0,noticeUnReadData:0,elem:"body",allRead:null,msgClick:null,noticeClick:null,msgShow:5,noticeShow:5,height:350,getNodeHtml:null},t={nodeList:[],tp:null,config:function(t){return $.extend(!0,n,t),this.nodeList=[],this},init:function(t){if(t!==undefined&&this.config(t),n.elem===undefined||typeof n.elem!="string")throw"option.elem is undefined";var i=$(n.elem).attr("class");return $(n.elem).attr("class",i?i:" message-bell"),this.bellDraw(),this.listener(),this},bellDraw:function(){var t="<span data-type='1' class='message-bell-btn' "+(n.msgUnReadData>0?"title='"+n.msgUnReadData+"条新消息'":"")+"><i class='fa fa-bell-o '><\/i>"+(n.msgUnReadData>0?"<span class='badge-dot'><\/span>":"")+"<\/span><span data-type='2' class='message-bell-btn' "+(n.noticeUnReadData>0?"title='"+n.noticeUnReadData+"条新提醒'":"")+"><i class='fa fa-at'><\/i>"+(n.noticeUnReadData>0?"<span class='badge'>"+n.noticeUnReadData+"<\/span>":"")+"<\/span>";$(n.elem).html(t)},listener:function(){var t=this;$(n.elem).on("click",".message-bell-btn",function(){$(".message-frame").length>0&&$(".message-frame").remove();var n=$(this).attr("data-type");t.tp=n;t.contentListDraw(n);t.caculatePosition(this)});$(document).on("click",".message-content-list li",function(){if($(this).find(".badge-dot").length>0){var i=t.tp;i==1?n.msgClick&&typeof n.msgClick=="function"?n.msgClick(this):"":i==2&&(n.noticeClick&&typeof n.noticeClick=="function"?n.noticeClick(this):"");$(this).find(".badge-dot").length>0&&(i==1?n.msgUnReadData>0?n.msgUnReadData-=1:"":i==2&&(n.noticeUnReadData>0?n.noticeUnReadData-=1:""),$(this).find(".badge-dot").remove())}});$(document).on("click",".message-btn-header",function(){var i=t.tp;n.allRead&&typeof n.allRead=="function"&&n.allRead(i,t)});$(document).on("click",".message-footer",function(){for(var e,o,s=$(".message-content-list li").length,u=t.tp,i=u==1?n.msgData:n.noticeData,f=0,r=s;r<i.length;r++)if(i[r]&&(e=t.getNode(i[r],u),t.nodeList.push(e),f++),f>n.msgShow)break;o=t.getNodelistHtml();$(".message-content-list").html(o);i.length<=t.nodeList.length&&$(this).hide()});$(document).click(function(n){var i=n.target,r=$(".message-frame *"),u=!0,f;if(i.className&&i.className.match("message-bell-btn")||i.parentElement&&i.parentElement.className.match("message-bell-btn"))u=!1;else{if(r&&r.length>0)for(f=0;f<r.length;f++)i&&i===r[f]&&(u=!1);i.className&&i.className.match("message-frame")&&(u=!1)}u&&($(".message-frame").remove(),t.nodeList=[],t.tp=null)})},caculateDate:function(n){var i,r;if(!n||isNaN(n))throw"time error";var f=new Date(n),e=new Date,u=e-f,t=Math.floor(u/864e5);return t&&t>0&&t<=1?t+"天前":t&&t>1?f.toLocaleDateString():(i=Math.floor(u/36e5),i&&i>0)?i+"小时前":(r=Math.floor(u/6e4),r&&r>0)?r+"分钟前":"刚刚"},contentListDraw:function(t){var e="",i,r,u,f;if($(".message-frame").length==0&&(e+="<div class='message-frame animated fadeIn' style='width: "+(n.width?n.width:"350")+"px' ><\/div>",$(n.elem).after(e)),this.nodeList=[],i="<div class='message-frame-header'><span style='height: 40px;line-height: 40px;text-align: center;width: 50px;    display: inline-block;'>"+(t==1?"消息":"提醒")+"<\/span><button class='message-btn message-btn-blue message-btn-header' data-type='"+t+"'>全部已读<\/button><\/div><div class='message-content' style='max-height:"+(n.height?n.height+"px":"350px")+"'>",t==1){if(n.msgData&&n.msgData.length>0){for(i+="<ul class='message-content-list'>",r=0;r<(n.msgData.length<n.msgShow?n.msgData.length:n.msgShow);r++)u=this.getNode(n.msgData[r],t),this.nodeList.push(u);f=this.getNodelistHtml();i+=f;i+="<\/ul>"}else i+="<div class='message-none-msg'>无消息<\/div>";i+="<\/div>";this.nodeList.length<n.msgData.length&&(i+="<div class='message-footer' data-type='"+t+"'><span>加载更多<\/span><\/div>")}else if(t==2){if(n.noticeData&&n.noticeData.length>0){for(i+="<ul class='message-content-list'>",r=0;r<(n.noticeData.length<n.msgShow?n.noticeData.length:n.msgShow);r++)u=this.getNode(n.noticeData[r],t),this.nodeList.push(u);f=this.getNodelistHtml();i+=f;i+="<\/ul>"}else i+="<div class='message-none-msg'>无提醒<\/div>";i+="<\/div>";this.nodeList.length<n.noticeData.length&&(i+="<div class='message-footer' data-type='"+t+"'><span>加载更多<\/span><\/div>")}$(".message-frame").html(i)},update:function(n,t,i,r){this.refresh(this.tp,n);t&&this.messageNotify(i,r)},refresh:function(n,t){this.config(t);this.bellDraw();n&&(this.contentListDraw(n),this.caculatePosition($(".message-bell-btn[data-type='"+n+"']").get(0)))},caculatePosition:function(n){for(var o=window.innerWidth,s=window.innerHeight,r=n.getBoundingClientRect(),t=r.left,i=r.bottom,u=10,h=$(".message-frame").outerWidth(),c=$(".message-frame").outerHeight(),f,e;t+h>o;)t-=u;for(f=t;i+c>s;)i-=u;e=i;$(".message-frame").css("position","fixed").css("left",f).css("top",e)},getNode:function(t,i){var r={type:i,isRead:!0},f=n.getNodeHtml&&typeof n.getNodeHtml=="function"?n.getNodeHtml(t,r):null,u;return f?$.extend(!0,r,f):r,u="<li id="+t.id+">",r.isRead||(u+="<div class='message-content-list-item-detail message-content-list-item-dot'><span class='badge-dot'><\/span><\/div>"),u+="<div class='message-content-list-item-content'>"+r.html+"<\/div>",u+="<\/li>",r.html=u,r},getNodelistHtml:function(){for(var t=this.nodeList,i="",n=0;n<t.length;n++)i+=t[n].html;return i},messageNotify:function(n,t){var i=window.Notification||window.mozNotification||window.webKitNotification,r,u;i&&i.permission!=="granted"?i.requestPermission(function(n){i.permission!==n&&(i.permission=n)}):i&&i.permission==="granted"&&(r={dir:"rtl",lang:"zh-CN",body:t},u=new i(n,r))}};window.MessagePlugin=t}();