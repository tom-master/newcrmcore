        ...
        public async Task<App> InstallAsync(Int32 userId, Int32 appId, Int32 deskNum)
        {
            ...
            return await Task.Run<App>(() =>
            {
                ...
                try
                {
                    ...
                    #region 添加桌面应用
                    {
                        var newMember = new Member(app.Name, app.IconUrl, app.AppUrl, app.Id, app.Width, app.Height, userId, app.AppStyle, app.IsIconByUpload, app.IsSetbar, app.IsOpenMax, app.IsFlash, app.IsResize);
